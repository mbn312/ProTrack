function onPageOpen() {
    ...
    confirmMyInput.onkeyup = function() {
                ...
                var passEqualsConfPass = (document.getElementById("psw").value == document.getElementById("cpsw").value);
                console.log(passEqualsConfPass) // TODO: Change this to the condition that needs to be checked so that the text entered in password equals the text in confirm password
...
function enableButton(letter, capital, number, length, match) {
    ...
    //if all confitions are valid, all class lists check boolean value
    if(condition) {
